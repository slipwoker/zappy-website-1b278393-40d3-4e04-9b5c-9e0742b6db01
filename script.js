  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && !validators.required(value)) {
        ...
        } else if (fieldType === 'tel' && !validators.tel(value)) {
    ...
    function getFormFields() {
      ...
      ).filter((field) => field.type !== 'submit' && field.type !== 'button' && field.type !== 'reset');
    }
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target;
      if (field.matches('input, textarea, select') &&
          field.classList.contains(ERROR_CLASS)) {
        validateField(field);
      }
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1b278393-40d3-4e04-9b5c-9e0742b6db01',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1b278393-40d3-4e04-9b5c-9e0742b6db01';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1b278393-40d3-4e04-9b5c-9e0742b6db01';
